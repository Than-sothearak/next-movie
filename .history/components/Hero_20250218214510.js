...
export const Hero = ({ movies }) => {
  ...
  return (
    <section
      className="w-full max-2xl:h-screen p-10 m-auto max-2xl:px-2 flex flex-col justify-center gap-10 relative bg-cover bg-center transition-all duration-1000"
      style={{
    ...
    >
      ...
      <div className="2xl:absolute top-64 max-sm:top-0 px-10 2xl:w-3/4 flex flex-col justify-start items-start w-full pt-28 gap-5 text-white z-10">
