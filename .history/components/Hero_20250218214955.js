...
export const Hero = ({ movies }) => {
  ...
  return (
    ...
    >
      ...
      <div className="2xl:absolute top-6 max-lg-top-40 max-sm:top-0 px-10 2xl:w-3/4 flex flex-col justify-start items-start w-full pt-28 gap-5 text-white z-10">
